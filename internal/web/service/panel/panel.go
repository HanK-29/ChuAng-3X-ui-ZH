...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/HanK-29/ChuAng-3X-ui-ZH/main/update.sh"
...
func (s *PanelService) StartUpdate() (int64, error) {
	return 0, fmt.Errorf("ChuAng 最终版不提供面板更新")
}
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/HanK-29/ChuAng-3X-ui-ZH/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/HanK-29/ChuAng-3X-ui-ZH/releases/tags/" + tag
	}
