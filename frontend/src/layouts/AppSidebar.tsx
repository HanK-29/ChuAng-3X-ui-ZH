...
const DOCS_URL = 'https://github.com/HanK-29/ChuAng-3X-ui-ZH/blob/main/README.zh_CN.md';
const REPO_URL = 'https://github.com/HanK-29/ChuAng-3X-ui-ZH';
    ...
    >
      ...
      >
        <div className="sider-brand">
          <div className="brand-block">
            <span className="brand-text">{railCollapsed ? 'CA' : 'ChuAng'}</span>
          </div>
          {!railCollapsed && (
      ...
      >
        <div className="drawer-header">
          <div className="brand-block">
            <span className="drawer-brand">ChuAng</span>
          </div>
