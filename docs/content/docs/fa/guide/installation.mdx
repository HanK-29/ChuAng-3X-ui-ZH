...
bash <(curl -Ls https://raw.githubusercontent.com/HanK-29/ChuAng-3X-ui-ZH/main/install.sh) v3.4.0
```
...
docker run -d \
  ...
  --name 3x-ui \
  ghcr.io/HanK-29/ChuAng-3X-ui-ZH:latest
```
...
[صفحهٔ releases](https://github.com/HanK-29/ChuAng-3X-ui-ZH/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/HanK-29/ChuAng-3X-ui-ZH/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/HanK-29/ChuAng-3X-ui-ZH/tree/main/deploy) در مخزن
